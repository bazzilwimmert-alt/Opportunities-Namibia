...
const { ensureMembership } = require('../services/membership');
...
router.post('/signup', async (req, res) => {
  ...
  const { email, password, fullName, phone, acceptTerms } = parsed.data;
  ...
  await prisma.profile.create({
    data: { userId: user.id, name: fullName.split(' ')[0] || 'Profile 1' },
  });
